...
public interface SetupInteraction 
{
	...
	//exibe GUI(tela) para iniciar o jogo. Retorna 1 caso há a necessidade de configurar o jogo. Retorna 0 caso contrário
	public int exibirStart();  
        
	 //valorDificuldade corresponde a: Fácil: 1 ; Moderado = 2  ; Díficil = 3 
	public int inserirDificuldadeJogo(); 	
        
        //insere nome dos jogadores no vetor de string       
	public String [] inserirNomesJogadores();  
        
	//exibe GUI solicitando que o jogador lance os dados para definir ordem do jogo
	public void pedirRolarDadosInicial(String nomeJogador); 
        
	//exibe GUI mostrando pontos obtidos;
	public void mostrarPontosObtidosInicial(int pontosObtidos); 
        
	//exibe GUI mostrando que houve empate, solicita que o jogador lance dados novamente;
	public void mostrarEmpatePontosObtidosInicial(String nomeJogador); 
        
	//recebe vetor de strings já ordenados para exibir na GUI 
	public void mostrarOrdemJogo(String [] nomeJogadoresOrdenados); 
        
	//exibe cartao de projeto na GUI
	...
	/**exibe GUI Default com todas as informações do tabuleiro, cartas na mão do jogador, opções do jogo.*/
	public void exibirDefault(Jogo jogoAtual, Jogador jogador);
        
	/**exibe a GUI mostrando o número de cartas recebidas respeito o limite de cartas na mao*/
	public void mostrarNumberCardasDelivered(int numberCardsDelivered);	
        
	/**exibe GUI informando que engenheiro não pode ser demitido pois ele trabalhou naquela roodada*/
	public void exibirNaoDemiteEngenheiro();
        
	/**exibe GUI informandao que não pode haver contratação de engenheiro devido à excesso de pessoal*/
	public void exibirExcessoPessoal();	
        
	/**exibe GUI informando que não há recursos para ação solicitada*/ 
	public void exibirFaltaDinheiro(); 
        
	/**exibe GUI para jogador escolher mesa para alocar engenheiro contratado*/
	public int escolherMesa();
        
	/**exibe GUI para jogador escolher mesa para transferir módulo integrado*/
	...
	public Modulo[] exibirTabelaCorrecao(int habilidadeEngenheiro,Modulo[] artefatosInspecionadosBug);
        ...
        /**exibe GUI para jogador escolher mesa na qual o engenheiro deve trabalhar*/
	public int escolherMesadeTrabalho();	
        
	 /* @param modulos */
	/**exibe GUI ,com cartão de projeto, para jogador escolher qual módulo do cartão de projeto o engenheiro deve integrar*/
	public int escolherModuloProjeto(Modulo[] modulos); 	
        
	/**exibe GUI informando que engenheiro não pode integrar artefatos pois ele trabalhou naquela roodada*/
	public void exibirEngenheiroNaoIntegra();
        
	/**exibe GUI informaando que qualquer combinação de artefatos da mesa do jogador não coincide com a combinação de artefatos do módulo do projeto escolhido*/
	public void exibirQuantidadeArtefatosInsuficientes(); 
        
        /**exibe GUI informaando que engenheiro deve ter habilidade >=1 para integrar módulo do projeto escolhido*/
	public void exibirHabilidadeInsuficiente(); 
        
	/**exibe GUI informado que o modulo já foi integrado*/
	public void exibirModuloJaIntegrado(int mesa); 	
        
	/**habilita função do engenheiro da mesaTrabalho para trocar modulo integrado de mesa*/
	public void habilitarTrocarModuloIntegrado(int mesaTrabalho); 
        
        /**exibe GUI informando que a mesa já contém módulo integrado*/
	public void exibirMesaModulo();				
        
        /**exibe GUI informando que o jogador venceu*/
	...
	*  método recebe o índice da mesa do jogador para limitar escolha de artefatos*/
	public int [][] escolherArtefatos(int mesaTrabalho);
        ...
        /**escolhe uma quantidade de engenheiros de qualquer mesa do jogador, retornando os nomes do engenheiros*/
	public String[] escolherEngenheiro(Jogador jogadorAtual,int quantitdadeEngenheiro);	
	...
	//#ifdef ConceptCard
	public void exibirEfeitoinserido(Jogador jogadorAtual,CartaBonificacao cartaUtilizada); 
	//#endif

	public void exibirEfeitoinserido(Jogador jogadorAtual, Jogador jogadorAlvo, CartaPenalizacao cartaUtilizada, boolean condicaoSatisfeita); 
