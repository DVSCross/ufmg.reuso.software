...
public class CardsConstants 
{
	...
	public static final int NO_PROBLEM = 0;										
        ...
        /** Adiciona dificuldade em inspecionar artefatos*/
	public static final int ADD_DIFFICULTY_INSPECT_ARTIFACTS = 1;
        
        /** Adiciona dificuldade em corrigir artefatos*/
	public static final int ADD_DIFFICULTY_REPAIR_ARTIFACTS = 2;
        
        /** Adiciona pontos em complexidade do projeto*/
	public static final int ADD_POINTS_IN_COMPLEXITY = 3;
        
        /** Adiciona um valor de qualidade ao projeto*/
	public static final int ADD_PROJECT_QUALITY = 4;
        
        /** Todos os engenheiros perdem artefato*/
	public static final int ALL_ENGINEERS_LOSE_ARTIFACT = 6;
        
        /** Todos os engenheiros perdem artefato de desenho*/
	public static final int ALL_ENGINEERS_LOSE_DESIGN_ARTIFACT = 41;
        
        /** Todos os engenheiros perdem artefato de rasto*/
	public static final int ALL_ENGINEERS_LOSE_TRAIL_ARTIFACT = 7;	
        
        /** Nenhum engenheiro trabalha */
	public static final int ALL_ENGINEERS_NO_WORK = 8;
        
        /** Nenhum engenheiro produz artefato*/
	public static final int ALL_ENGINEERS_NOT_PRODUCE_ARTIFACTS = 22;
        
        /** Engenheiros com habilidade menor que 2 não inspeciona artefato*/
	public static final int ALL_ENGINEERS_WITH_SKILL_LESS_THAN_2_NOT_INSPECT_ARTIFACTS = 42;
        
        /** Todos perdem efeitos existentes de cartas conceito no tabuleiro*/
	public static final int ALL_LOSES_EFFECTS_CONCEPT_CARDS_ON_BOARD = 9; 	
        
        /** Todos os jogadoes,com mais de 2 engenheiros, demitem engenheiro*/
	public static final int ALL_PLAYERS_WITH_MORE_2_ENGINEERS_DISMISS_ENGINEER = 10; 
        
        /** Todos os jogadoes,com mais de 3 engenheiros, demitem engenheiro*/
	public static final int ALL_PLAYERS_WITH_MORE_3_ENGINEERS_DISMISS_ENGINEER = 5;

        /** Trocar cada artefato branco de desenho por artefato cinza*/         
	public static final int CHANGE_WHITE_DESIGN_ARTIFACTS_BY_GRAY_DESIGN_ARTIFACTS = 11; 	
        
        /** Engenheiro escolhido fica somente com uma quantidade de artefato de código*/
	public static final int ENGINEER_CHOSEN_IS_ONLY_QUANTITY_CODE_ARTIFACT = 13;
        
        /** Engenheiro escolhido perde todos artefatos*/
	public static final int ENGINEER_CHOSEN_LOSE_ALL_ARTIFACTS = 14;
        
        /** Engenheiro escolhido perde artefato*/
	public static final int ENGINEER_CHOSEN_LOSE_ARTIFACT = 15;
        
        /** Engenheiro escolhido perde artefato de código*/
	public static final int ENGINEER_CHOSEN_LOSE_CODE_ARTIFACT = 16;
        
        /** Engenheiro escolhido não trabalha */
	public static final int ENGINEER_CHOSEN_NO_WORK = 17;	
        
        /** Engenheiro escolhido tem penaliade para receber ou dar ajuda*/
	public static final int ENGINEER_CHOSEN_PENALTY_GIVING_OR_RECEIVING_HELP = 18; 
        
        /** Produz escolhido somente produz artefatos cinzas*/
	public static final int ENGINEER_CHOSEN_PRODUCE_ONLY_GRAY_ARTIFACTS = 19;

        /** Produz escolhido somente produz artefatos brancos*/
	public static final int ENGINEER_CHOSEN_PRODUCE_ONLY_WHITE_ARTIFACTS = 20; 
        
        /** Engenheiro escolhido é demitido no final da rodada*/
	public static final int ENGINEER_CHOSEN_UNEMPLOYMENT_LATER = 21;
        
        /** Engenheiro escolhido é demitido no início da rodada*/
	public static final int ENGINEER_CHOSEN_UNEMPLOYMENT_NOW = 12;						
	
        
        /** Perde todos os artefatos*/
	public static final int LOSE_ALL_ARTIFACTS = 36;	
        
        /** Perde todos os artefatos de código*/
	public static final int LOSE_ALL_CODE_ARTIFACTS = 38;	
        
        /** Perde todos os artefatos cinza de desenho*/
	public static final int LOSE_ALL_GRAY_DESIGN_ARTIFACTS = 43;	
        
        /** Perde todos os artefatos cinza de requisitos*/
	public static final int LOSE_ALL_GRAY_REQUIREMENTS_ARTIFACTS = 44;
        
        /** Perde todos os artefatos de desenho*/
	public static final int LOSE_ALL_DESIGN_ARTIFACTS = 23;	
        
        /** Perde todos os artefatos de requisitos*/
	public static final int LOSE_ALL_REQUIREMENTS_ARTIFACTS = 24;
        
        /** Perde artefato*/
	public static final int LOSE_ARTIFACT = 25;		
        
        /** Perde artefato de código*/
	public static final int LOSE_CODE_ARTIFACT = 26;
        
        /** Perde artefato de desenho*/
	public static final int LOSE_DESIGN_ARTIFACT = 27;
        
        /** Perde artefato de ajuda*/
	public static final int LOSE_HELP_ARTIFACT = 40;
        
        /** Perde artefato de requisitos*/
	public static final int LOSE_REQUIREMENTS_ARTIFACT = 39;
        
         /** Perde metade dos artefatos*/
	public static final int LOSE_HALF_OF_ARTIFACTS = 37; 	
        
        /** Perde metade dos artefatos de código*/
	public static final int LOSE_HALF_OF_CODE_ARTIFACTS = 28; 
        
        /** Perde metade dos artefatos de desenho*/
	public static final int LOSE_HALF_OF_DESIGN_ARTIFACTS = 29; 	
        
        /** Perde artefato de requisitos por cada bug*/
	public static final int LOSE_REQUIREMENTS_ARTIFACTS_FOR_EACH_BUG = 30;
        
        /** Perde artefato de rastro*/
	public static final int LOSE_TRAIL_ARTIFACT = 31;	
        
        /** Engenheiro de menor maturidade é demitido*/
	public static final int LOWER_MATURITY_ENGINEER_UNEMPLOYMENT = 32;	
        
	/** Somente inspeciona artefatos*/
	public static final int ONLY_INSPECT_ARTIFACTS = 33;	
        
        /** Redução no orçamento do projeto*/
	public static final int REDUCTION_IN_BUDGET = 34;
        
        /** Mesa escolhida perde todos artefatos de código*/
	public static final int TABLE_CHOSEN_LOSE_ALL_CODE_ARTIFACT = 35;			
	...
	public static final int UNCONDITIONAL = 0;	
        ...
        //TODO era 146, vai para 132
	public static final int AFFECTS_ALL_PLAYERS = 132; 			
	...
	public static final int REQUIREMENTS_LESS_THAN_5 = 68;
         ...
         //TODO era 145 vai para 133
	public static final int REQUIREMENTS_LESS_THAN_6 = 133;    
	...
	public static final int TABLE_WITH_BUG_CODE_ARTIFACTS = 94;	
        ...
        //TODO era 144 vai para 134
	public static final int TABLE_WITH_BUG_TRAIL_ARTIFACTS = 134;	 
	...
	/** Não há benefício*/
	public static final int NO_BENEFITS = 0;										
        
        /**Incrementa valor do orçamento*/
	public static final int BUDGET_INCREASE = 1;
        
        /** Trocar cada artefatos cinzas por artefatos brancos*/ 
	public static final int CHANGE_GRAY_ARTIFACTS_BY_WHITE_ARTIFACTS = 2; 	
        
        /**Engenheiro escolhido inspeciona artefatos gratuitamente*/
	public static final int ENGINEER_CHOSEN_INSPECT_FREE_ARTIFACTS = 10;	
        
        /**Engenheiro escolhido recebe artefato de ajuda*/
	public static final int ENGINNER_CHOSEN_RECEIVE_HELP_ARTIFACTS = 3;
        
        /**Engenheiro escolhido recebe pontos em maturidade, nessa rodada*/
	public static final int ENGINNER_CHOSEN_RECEIVE_MATURITY_POINTS_NOW = 4; 
        
        /**Engenheiro escolhido recebe artefato de requisitos*/
	public static final int ENGINNER_CHOSEN_RECEIVE_REQUIREMENTS_ARTIFACTS = 5;	
        
        /**Engenheiro escolhido recebe pontos em habilidade na próxima rodada*/
	public static final int ENGINNER_CHOSEN_RECEIVE_SKILL_POINTS_LATER = 6; 	
        
        /**Engenheiro escolhido recebe pontos em habilidade, nessa rodada*/
	public static final int ENGINNER_CHOSEN_RECEIVE_SKILL_POINTS_NOW = 7; 			
        
        /**Engenheiro escolhido recebe artefato de rastro*/
	public static final int ENGINNER_CHOSEN_RECEIVE_TRAIL_ARTIFACTS = 8;			
        
        /**Engenheiro escolhido recebe artefato branco*/
	public static final int ENGINNER_CHOSEN_RECEIVE_WHITE_ARTIFACT = 9; 
        
        /**Engenheiro escolhido recebe artefato de código branco*/
	public static final int ENGINNER_CHOSEN_RECEIVE_WHITE_CODE_ARTIFACT = 19; 
        
	/** 2 Engenheiros escolhidos recebem artefato de desenho*/
	public static final int TWO_ENGINNERS_CHOSEN_RECEIVE_DESIGN_ARTIFACTS = 11;
        
        /** 2 Engenheiros escolhidos recebem artefato de rastro*/
	public static final int TWO_ENGINNERS_CHOSEN_RECEIVE_TRAIL_ARTIFACTS = 12;		
        
        /**Imunizar componente nessa rodada*/
	public static final int	UNIZING_COMPONENT_NOW = 13;
        
        /**Imunizar componente na fase de validação.*/
	public static final int	UNIZING_COMPONENT_VALIDATION_PHASE = 14;
        
        /**Imunizar artefatos de ajuda na fase de validação.*/
	public static final int	UNIZING_HELP_ARTIFACTS_VALIDATION_PHASE = 15;	
        
        /**Neutraliza carta de problema relacionada é artefatos de código*/ /*TODO*/ //- usou e acabou né?
	public static final int UNIZING_PROBLEM_CARD_RELATED_CODE = 16;		
        
        /**Neutraliza carta de problema relacionada é artefatos de requisitos*/ /*TODO*/ //- usou e acabou n�?
	public static final int UNIZING_PROBLEM_CARD_RELATED_REQUIREMENTS = 17;	
        
        /**Neutraliza carta de problema relacionada é artefatos de rastros*/ /*TODO*/ //- usou e acabou né?
	public static final int UNIZING_PROBLEM_CARD_RELATED_TRAILSS = 18;				
