...
public class ScreenInteraction implements SetupInteraction {
	...
	public void exibirResultadoQuestao(boolean acertou) {
		if (acertou)
			JOptionPane.showMessageDialog(this.tabuleiro, "Parab�ns, voc� acertou! Por isso, voc� receber� uma m�o completa de cartas!");
		else
			JOptionPane.showMessageDialog(this.tabuleiro, "Que pena, voc� errou! Tente estudar mais.");
	}
}
